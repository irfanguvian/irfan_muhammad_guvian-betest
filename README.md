...
1. **Clone the Repository**
   ```bash
   git clone https://github.com/your-username/user-auth-services-betest.git
   cd user-auth-services-betest
   ```
...
To help you test the API endpoints, a Postman collection is available for download [here](https://drive.google.com/drive/folders/1nO6OajyNTlHEoygMdqq5zvaxd9MGFOxC?usp=sharing).
...
### Built By
* [Irfan Muhammad Guvian](https://www.linkedin.com/in/irfanguvian/)